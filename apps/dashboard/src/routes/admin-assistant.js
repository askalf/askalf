...
- **db_query**: Run read-only SQL queries against the askalf database (tables: agent_tickets, agent_findings, agent_interventions, agent_schedules, users, sessions)
...
- For fleet queries, prefer db_query or db_query over generic tools when you need specific data.
