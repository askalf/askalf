    ...
    case 'create': {
      ...
      if (severity === 'critical') {
        ...
        if (existing.rows.length === 0) {
          ...
          if (category === 'security') assignTo = 'Security Scanner';
          else if (category === 'performance' || category === 'optimization') assignTo = 'Builder';
          else if (category === 'infrastructure' || category === 'infrastructure_status') assignTo = 'Ops Worker';
          else if (category === 'bug') assignTo = 'Troubleshooter';
          else if (category === 'service_outage') assignTo = 'Ops Worker';
          if (!assignTo) assignTo = 'Builder';
