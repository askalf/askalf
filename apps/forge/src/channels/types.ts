...
export type ChannelType = 'api' | 'webhooks' | 'slack' | 'discord' | 'telegram' | 'whatsapp' | 'teams' | 'zapier' | 'n8n' | 'make' | 'email' | 'twilio' | 'sendgrid' | 'twilio_voice' | 'zoom' | 'openclaw';

export const CHANNEL_TYPES: ChannelType[] = ['api', 'webhooks', 'slack', 'discord', 'telegram', 'whatsapp', 'teams', 'zapier', 'n8n', 'make', 'email', 'twilio', 'sendgrid', 'twilio_voice', 'zoom', 'openclaw'];
