...
export function initializeDatabase(_connectionString: string): void {
  console.log('[DB] initializeDatabase is a no-op (merged into askalf)');
}
...
// Aliases — askalf tables are in the same database
export const query = query;
export const queryOne = queryOne;
export const getPool = getPool;
