...
-- Schedule: every 120 minutes (substrate DB)
...
INSERT INTO forge_agents (
  ...
  'claude-haiku-4-5',
  2,
  ARRAY['security_scan', 'db_query', 'substrate_db_query', 'docker_api', 'shell_exec', 'finding_ops', 'ticket_ops', 'intervention_ops', 'audit_inspect'],
  'active',
  'monitor',
  15,
  4096,
...
-- Schedule: every 60 minutes (substrate DB)
-- INSERT INTO agent_schedules (agent_id, schedule_type, schedule_interval_minutes, is_continuous, next_run_at)
...
INSERT INTO forge_agents (
  ...
  'claude-sonnet-4-5',
  3,
  ARRAY['knowledge_graph_ops', 'knowledge_search', 'memory_store', 'memory_search', 'db_query', 'substrate_db_query', 'finding_ops', 'ticket_ops', 'event_query', 'feedback_ops'],
  'active',
  'research',
  20,
  8192,
...
-- Schedule: every 180 minutes (substrate DB)
-- INSERT INTO agent_schedules (agent_id, schedule_type, schedule_interval_minutes, is_continuous, next_run_at)
...
-- Schedule: every 360 minutes (substrate DB)
-- INSERT INTO agent_schedules (agent_id, schedule_type, schedule_interval_minutes, is_continuous, next_run_at)
...
-- Schedule: every 45 minutes (substrate DB)
-- INSERT INTO agent_schedules (agent_id, schedule_type, schedule_interval_minutes, is_continuous, next_run_at)
...
-- Schedule: every 240 minutes (substrate DB)
-- INSERT INTO agent_schedules (agent_id, schedule_type, schedule_interval_minutes, is_continuous, next_run_at)
