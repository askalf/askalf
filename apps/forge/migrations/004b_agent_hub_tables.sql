-- Agent Hub tables for askalf database
-- Run via: docker exec askalf-postgres psql -U askalf -d askalf -f /tmp/agent-hub-tables.sql
-- Or paste into: docker exec -it askalf-postgres psql -U askalf -d askalf
