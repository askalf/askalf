...
|-------|------|-------|--------|
| 1 | Write `034_schema_consolidation.sql` migration | Builder | TBD |
| 2 | Fix N+1 query + audit_log consistency in `tickets.ts` | Builder | Same ticket |
| 3 | Test migration on existing database | Builder | Same ticket |
