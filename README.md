...
**18 fixes merged upstream** into Node.js, Hugging Face, Erigon, GitHub, Raycast, Taro, Lingui, gosec, Sprayberry Archive and more
...
| [sprayberry-archive/agent-security-stack #26](https://github.com/sprayberry-archive/agent-security-stack/pull/26) · [#35](https://github.com/sprayberry-archive/agent-security-stack/pull/35) | The security-stack documentation now says the redstamp checkpoint protection has applied since 0.5.1, avoiding an implication that 0.5.1 is its current version. |
...
| [sprayberry-archive/agent-security-stack #32](https://github.com/sprayberry-archive/agent-security-stack/pull/32) | Records the merged upstream security-stack update. |
| [sprayberry-archive/agent-security-stack #33](https://github.com/sprayberry-archive/agent-security-stack/pull/33) | Adds plumbline to the README related tools section and stages a commented OpenSSF Best Practices badge. |
