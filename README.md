...
| **[brio](https://github.com/askalf/brio)** | A capability layer for AI workloads. Sits in front of any Anthropic-compat endpoint — semantic cache, cost-aware tiering, structured cost reporting, policy enforcement. Drop-in: existing tools point at brio instead of the upstream and start saving. | [![npm](https://img.shields.io/npm/v/@askalf/brio?logo=npm&logoColor=white&label=npm&color=00ff88&style=flat-square)](https://www.npmjs.com/package/@askalf/brio) |
