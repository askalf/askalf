...
| **[casey](https://github.com/askalf/casey)** | An AI IT service desk. Omnichannel intake — email, web chat, Slack, Discord, Teams, SMS, voice — then Tier-1 triage and Tier-2 guided troubleshooting: it resolves what it can, walks the client through the rest, and escalates hands-on work to arnie with a brief. Routes through dario. | [![npm](https://img.shields.io/npm/v/casey-cli?logo=npm&logoColor=white&label=npm&color=00ff88&style=flat-square)](https://www.npmjs.com/package/casey-cli) |
