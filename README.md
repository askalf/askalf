...
> **redstamp · truecopy** compose into one layered defense → **[agent-security-stack](https://github.com/askalf/agent-security-stack)** — vet the tool, contain the call. **[plumbline](https://github.com/askalf/plumbline)** watches the whole trajectory from out of band.
