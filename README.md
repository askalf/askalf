...
| **[git-providers](https://github.com/askalf/git-providers)** | **own your git** — one interface across GitHub, GitLab, and Bitbucket: repos, issues, and pull requests, SSRF-guarded; switch providers without rewriting your integration | [![npm](https://img.shields.io/npm/v/@askalf/git-providers?logo=npm&logoColor=white&label=&color=8b5cf6&style=flat-square)](https://www.npmjs.com/package/@askalf/git-providers) |
