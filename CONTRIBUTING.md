...
This guide covers everything you need to contribute to the AskAlf monorepo.
...
Migrations are numbered sequentially from `001` through `064`. Check the directory for the latest number before adding a new one.
